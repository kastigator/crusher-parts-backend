...
12. Use the project [Definition of Done](https://github.com/kastigator/crusher-parts-backend/blob/4e7d0a10fad219f286a147d8d46fcf9028695f42/docs/definition-of-done.md) and require `npm run review:preflight` evidence for substantial implementation reviews.
