const DOMAIN_ENTITIES = [
  ...
  {
    key: 'standard_part',
    label_ru: 'Стандартная деталь',
    purpose: 'Каноническая типовая деталь: крепеж, болт, гайка, электродвигатель и другие стандартные изделия.',
    canonical: {
      table: 'standard_parts',
      api_route: '/standard-parts',
      frontend_sections: ['Каталоги -> Стандартные детали'],
    },
    legacy_or_compatibility: {
      tables: [],
      api_routes: [],
    ...
    user_words: ['стандартная деталь', 'типовая деталь', 'крепеж', 'болт', 'гайка', 'электродвигатель'],
    status: 'canonical',
    guidance:
      'Это не классификатор оборудования. Это каталог типовых изделий, через который можно связывать OEM и поставщиков.',
  },
  {
