CREATE TABLE IF NOT EXISTS technical_identification_tasks (
...
CREATE TABLE IF NOT EXISTS technical_identification_task_events (
...
CREATE TABLE IF NOT EXISTS client_request_intake_commands (
  id BIGINT NOT NULL AUTO_INCREMENT,
